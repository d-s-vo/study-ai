...
| FEAT-004 | `feat/breeze-inertia-auth` | cbook | ✅ done (merged → develop+main) | e0c8ee3 | Breeze (Inertia/Vue3/TS/Tailwind) + enterprise-рефактор авторизации: мутации User только через `UserRepository`/`RegisterUserTask` |
<!-- FEAT-MAP:END -->
