...
**needs propagation**: появился новый user-visible раздел «Рецепты» (список/деталь/создание/редактирование) и пункт меню в навигации. Клиентские `README`/`CLAUDE.md` **не обновлялись** в этом коммите — по спеке формулировка пункта меню/навигации отмечена «согласовать с владельцем»; нужна отдельная правка клиентской документации после согласования с владельцем продукта.
